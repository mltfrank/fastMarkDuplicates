...
public abstract class SamReaderFactory {
    ...
    public enum Option {
         ...
         * <p/>
         * This option increases memory footprint slightly per {@link SAMRecord}.
         */
         ...
         * @see SamReader.Indexing#getIndex()
         */
        ...
        /**
         * Eagerly decode {@link SamReader}'s {@link SAMRecord}s, which can reduce memory footprint if many
        ...
        /**
         * For {@link SamReader}s backed by block-compressed streams, enable CRC validation of those streams.  This is an
