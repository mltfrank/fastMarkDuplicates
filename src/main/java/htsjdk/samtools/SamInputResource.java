 ...
 * <p/>
 * A data or index source may originate from a {@link File}, {@link InputStream}, {@link URL}, or
 * {@link SeekableStream}; look for the appropriate overload for
 ...
 * {@link SeekableStream} or {@link InputStream}.  A concrete implementation of this class exists for
 * each of {@link Type}.
 */
abstract class InputResource {
    ...
    /** Returns null if this resource cannot be represented as a {@link SeekableStream}. */
    abstract SeekableStream asUnbufferedSeekableStream();

    /** All resource types support {@link InputStream} generation. */
